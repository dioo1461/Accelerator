...
public class MyStringMethods : MonoBehaviour
{
	...
	/// </summary>
	public string String_Assembler(string str_1, string str_2, string str_3 = null, string str_4 = null, string str_5 = null, string str_6 = null, string str_7 = null, string str_8 = null, string str_9 = null, string str_10 = null) {
		int _count = 2;
		if (str_3 != null) {
			_count++;
			if (str_4 != null) {
